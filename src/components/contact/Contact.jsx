      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <div className="contact__option">
            ...
            <h4>LinkedIn</h4>
            <h5>shubham goyal</h5>
            <div class="badge-base LI-profile-badge" data-locale="en_US" data-size="medium" data-theme="light" data-type="HORIZONTAL" data-vanity="shubham-goyal-7987461b8" data-version="v1"><a class="badge-base__link LI-simple-link" target="_blank" rel="noopener noreferrer" href="https://in.linkedin.com/in/shubham-goyal-7987461b8?trk=profile-badge">Let's Connect and Talk</a></div>
          </div>
